...
export const Experiencia = () => {
    return (
        <section className='overflow-hidden text-center mt-24'>
            ...
            <div className="bg-[#F2F2F2] flex flex-col lg:flex-row p-4 gap-8 pb-6 lg:justify-center lg:items-center lg:w-[1100px] lg:mx-auto lg:max-w-screen-lg lg:rounded-[3rem]">
                ...
                <article className='text-left flex flex-col justify-center gap-7 max-w-[95vw] pb-4 lg:w-1/2 lg:p-5 lg:gap-5'>
                    ...
                    <p className="lg:text-lg">Como parte de la estrategia acompañamos a los creadores de contenido Cristóbal Combes y Juli Castro al impresionante show de Fuerza Bruta, donde el Banco Supervielle instaló su activación para que mostraran en sus redes toda la experiencia.</p>
                ...
                <div className="w-1/2">
                    <img src="img/superville-ig-story.png" alt="Superville Instagram" />
                </div>
            </div>
        </section>
    )
