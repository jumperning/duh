...
export const ExperienciaItem = (props: any) => {
    return (
        <div className={`${props.isActive ? "opacity-100" : "opacity-0"} duration-500 bg-[#F2F2F2] flex flex-col lg:flex-row p-4 gap-8 pb-6 lg:mt-20 lg:justify-center lg:items-center lg:w-[1100px] lg:mx-auto lg:max-w-screen-lg lg:rounded-[3rem]`}>
