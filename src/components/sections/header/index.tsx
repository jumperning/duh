        ...
        <nav className="w-full flex justify-center items-center">
            <div className="w-full p-6 flex flex-row justify-between items-start lg:items-center max-w-[1024px] bg-[#965BDD]">
                ...
                <div className="w-full flex justify-end">
                    ...
                    <div
                        className={`${showMenu ? "opacity-100" : "lg:opacity-100 opacity-0"} z-30 bg-[#965BDD] duration-300 absolute inset-x-0 lg:static flex flex-col lg:flex-row justify-end items-center gap-2 w-full lg:w-auto shadow-md lg:shadow-none pb-4`}
                        style={{
                    ...
                    >
                        {menuOptions.map((menu: { id: string, name: string }, index: number) => {
                            return (
                                <Link key={index} to={menu.id} smooth={true} duration={500} className="w-full h-12">
